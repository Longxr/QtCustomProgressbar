...
void RingsProgressbar::setFrontColor(QColor color)
{
...
void RingsProgressbar::setBackColor(QColor color)
{
...
void RingsProgressbar::setClockwiseRotate(bool clockwise)
{
...
void RingsProgressbar::drawDonutWait(QPainter &p)
{
